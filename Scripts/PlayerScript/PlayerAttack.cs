...
public class PlayerAttack : MonoBehaviour {
    ...
    // private GameObject targetLOOKROOT;

    // private GameObject targetZOOMCAM;
    ...
    void Awake() {
        ...
        // targetLOOKROOT= GameObject.FindWithTag("Look Root");

        // targetZOOMCAM= GameObject.FindWithTag("FP Camera");


        // zoomCameraAnim = targetLOOKROOT.transform
        //                                         .targetZOOMCAM.transform.GetComponent<Animator>();
